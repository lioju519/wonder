...
#FUNCION QUE RECIBE DEL BOTIN LO QUE SE VA A ACTUALIZAR VIENE DE LA VISTA LOTES PARA CUADRR LAS CANTIDADES PRECIO A EJECUTAR EL CARGUE
...
def salidasLotes():
    ...
    with conexion.cursor() as cursor:
        ...
        for j in data_lotes:
            ...
            calculoLotes(sku_indivisible, total_venta, id)
           
    return 'hola'


#función para realizar el calculo de los lotes por cada sku ya sea multiple o unitario
def calculoLotes(sku_indivisible, total_venta, id):
    conexion = obtener_conexion()
    ...
    while total_venta > 0:
        ...
        if total_venta < cantidad:
            ...
            print('cantidad ', cantidad, '=', cantidad, '-', total_venta)
